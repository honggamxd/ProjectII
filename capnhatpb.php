...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    foreach ($values as $key => $tb) {
        $DVSD = isset($_POST['ĐVSD'.$key]) ? $_POST['ĐVSD'.$key] : null;
        $TenP = isset($_POST['TenP'.$key]) ? $_POST['TenP'.$key] : null;
        $Dientich = isset($_POST['Dientich'.$key]) ? $_POST['Dientich'.$key] : null;
        $idtb = $tb['idPhongban'];

        global $conn;
        $sql = "UPDATE phongbann SET ĐVSD ='$DVSD', TenP ='$TenP', Dientich ='$Dientich' WHERE idPhongban = '$idtb'";
...
<head>
    ...
    <title>QLCSVC - Cập nhật phòng ban</title>
        ...
        <li class="nav-item active">
            ...
            <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item active" href="capnhatpb.php">Cập nhật dữ liệu</a>
                </div>
            </div>
        </li>
        <hr class="sidebar-divider my-0">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Cơ sở vật chất Viện CNTT&TT </h1>
                <p class="mb-4">Không gian làm việc và trang thiết bị của Viện Công nghệ thông tin và Truyền thông được
                    bố trí tại Tòa nhà B1, Tòa nhà D5 và Tòa nhà Thư viện Tạ Quang Bửu.

                    Bảng chỉ dẫn không gian làm việc của Viện Công nghệ thông tin và Truyền thông.</p>
                                    ...
                                    <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                        ...
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                ...
                                                style="width: 20%;">Địa điểm
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 20%;">Đơn vị
                                            </th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="dataTable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 50%;">Tên phòng
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Office: activate to sort column ascending"
                                                style="width: 10%;">Diện tích(m2)
                                            </th>
                                        </tr>
                                        </thead>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" value="<?php echo $tb["ĐVSD"] ?>"
                                                           class="form-control" id="exampleInputPassword1"
                                                           name="ĐVSD<?php echo $key ?>" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="exampleInputPassword1"
                                                           name="TenP<?php echo $key ?>" value="<?php echo $tb["TenP"] ?>"
                                                           placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="exampleInputPassword1"
                                                           name="Dientich<?php echo $key ?>" value="<?php echo $tb["Dientich"] ?>"
                                                           placeholder="">
                                                </div>
                                            </td>
                                            <?php } ?>
