...
$PHPExcel->getActiveSheet()->setTitle('Thiết bị thanh lý');
$PHPExcel->getActiveSheet()->setCellValue('E1', 'DỮ LIỆU THIẾT BỊ THANH LÝ');
$PHPExcel->getActiveSheet()->setCellValue('J10', 'Nhân viên ký tên');
$PHPExcel->getActiveSheet()->setCellValue('J11', '(Ký, ghi rõ họ tên)');
