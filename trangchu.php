...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
      <a class="nav-link collapsed" href="xuatdulieu.php" data-toggle="collapse" data-target="#collapsePages1" aria-expanded="true" aria-controls="collapsePages">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Hệ thống Cơ sở vật chất - thiết bị Viện Công nghệ thông tin và Truyền thông</h1>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        <p class="mb-4">Sinh viên được trải nghiệm trong môi trường thân thiện, hệ thống cơ sở vật chất hiện đại, đáp ứng nhu cầu học tập, nghiên cứu, tham gia các hoạt động thể thao, giải trí đa dạng.</p>
                        <p class="mb-4">Khu vực Văn phòng Viện, Văn phòng các Bộ môn, các Phòng thí nghiệm phục vụ đào tạo, các Phòng thí nghiệm nghiên cứu được bố trí tại Tòa nhà B1. Hiện nay, Viện đang xây dựng  thêm 5 Phòng thí nghiệm nghiên cứu chuyên sâu.
                        </p>
                        <p class="mb-4">Phòng thí nghiệm Hệ thống máy tính, đặt tại P505 Tòa nhà B1, được đầu tư với nhiều trang thiết bị hiện đại phục vụ nghiên cứu thiết kế máy tính hiệu năng cao, máy tính nhúng phục vụ cho các ứng dụng trong nhiều lĩnh vực khác nhau, các hệ thống xử lý tín hiệu và xử lý tiếng Việt, …
                            Trung tâm máy tính được bố trí tại tầng 3 nhà D5, với khoảng 200 máy tính, là nơi đào tạo thực hành Tin học đại cương cho sinh viên toàn trường và một số môn học về Công nghệ thông tin.</p>
                        <p class="mb-4">Dự án Đào tạo về Công nghệ thông tin và Truyền thông Việt-Nhật được đặt tại tầng 8 tòa nhà Thư viện Tạ Quang Bửu với hệ thống trang thiết bị hiện đại đạt tiêu chuẩn cao, bao gồm:Khu vực Văn phòng; Các phòng làm việc của giáo viên tiếng Nhật; 04 phòng thực hành máy tính với 164 máy tính; 01 phòng thực hành mạch logic với các thiết bị thực hành như các bảng mạch, máy hiện sóng, máy phát tín hiệu, bộ nguồn một chiều; Thư viện; Phòng hội thảo.</p>
                    </div>
                </div>
            </div>
