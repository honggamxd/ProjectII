    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Chưa đủ quyền thực hiện chức năng này</h1>
                <div class="modal-title">

                    <a class="btn btn-secondary" type="button" href="trangchu.php">Trở lại Trang chủ</a>
                </div>
            </div>
                <!-- DataTales Example -->
