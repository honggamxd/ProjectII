        ...
        <li class="nav-item active">
            ...
            <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item active" href="thongtinpb.php">Thông tin</a>
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                            ...
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="dataTable"
                                                    ...
                                                    style="width: 57px;">Tên phòng
                                                </th>

                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                    colspan="1" aria-label="Office: activate to sort column ascending"
                                                    style="width: 50px;">Diện tích(m2)
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                    colspan="1" aria-label="Age: activate to sort column ascending"
                                                    style="width: 31px;">Địa điểm
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                    colspan="1" aria-label="Position: activate to sort column ascending"
                                                    style="width: 62px;">Đơn vị
                                                </th>
                                            ...
                                            <tr role="row" class="odd">
                                                <td><?php echo $room["TenP"] ?></td>
                                                <td><?php echo $room["Dientich"] ?></td>
                                                <td><?php echo $room["Diadiem"] ?></td>
                                                <td><?php echo $room["ĐVSD"] ?></td>
                                                <?php } ?>
